...
/**
  ...
  /**
   * `prisma.cultural`: Exposes CRUD operations for the **Cultural** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Culturals
    * const culturals = await prisma.cultural.findMany()
    * ```
    */
  get cultural(): Prisma.CulturalDelegate<ExtArgs, { omit: OmitOpts }>;
}
